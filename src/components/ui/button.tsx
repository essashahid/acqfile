...
export const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-[var(--r-md)] border font-medium transition-[background-color,border-color,color,box-shadow] duration-100 disabled:pointer-events-none disabled:opacity-45 aria-disabled:pointer-events-none aria-disabled:opacity-45",
  {
    variants: {
      variant: {
        primary:
          "border-[var(--accent)] bg-[var(--accent)] text-white shadow-[var(--shadow-sm)] hover:border-[var(--accent-hover)] hover:bg-[var(--accent-hover)]",
        secondary:
          "border-[var(--line-strong)] bg-[var(--surface)] text-[var(--fg)] shadow-[var(--shadow-sm)] hover:border-[var(--faint)] hover:bg-[var(--surface-hover)]",
        ghost:
          "border-transparent bg-transparent text-[var(--muted)] hover:bg-[var(--surface-sunken)] hover:text-[var(--fg)]",
        danger:
          "border-[var(--bad-border)] bg-[var(--surface)] text-[var(--bad)] shadow-[var(--shadow-sm)] hover:bg-[var(--bad-soft)]",
