...
export const LocatorSchema = z.strictObject({ file: z.string().min(1), page: z.number().int().positive(), source_block: z.string().min(1), quote: z.string().min(1), region: z.string().min(1).optional(), verbatim: z.boolean().optional() });
