...
export function dealA(){
 ...
 // A43 planted extraction faults. Expected routing reasoned from A39: text score = 0.30 exact + 0.20 validation + 0.25 verifier + 0.15 cross-pass + 0.10 specificity; unsupported or contradicted evidence blocks regardless; vision never auto-accepts.
 ...
 fault(p,{id:'A-F4',document:'tax-2024',attribute:'tax.gross_receipts',kind:'verifier_corrects',expected:'review',description:'Extractor misreads receipts; the verifier corrects from the cited line: 0.30+0.20+0.125+0.15+0.075 = 0.85, review with a suggested correction.',extractor:{value:1030000,quote:'gross receipts: 1300000'},verifier:{status:'partially_supported',corrected_value:1300000,contradiction:false,specificity:0.75}});
