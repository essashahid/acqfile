...
describe("logical keys", () => {
  it("extracts the report identifier from fixture-style filenames", () => {
    expect(deriveLogicalKey("OPS-2026-004-v2-zelmivar-operational-review-corrected.pdf")).toBe("OPS-2026-004");
    expect(deriveLogicalKey("copy-of-AUD-2026-011-v1-zelmivar-equipment-audit-report.pdf")).toBe("AUD-2026-011");
    expect(deriveLogicalKey("inc-2026-012-v1-zelmivar-equipment.docx")).toBe("INC-2026-012");
  });
  ...
  it("derives display names and mime types", () => {
    expect(deriveDisplayName("copy-of-AUD-2026-011-v1-zelmivar-equipment.pdf")).toBe("AUD 2026 011 zelmivar equipment");
